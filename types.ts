...
export interface ActivityStatistics {
  ...
  total_google_wallet: number;
  successful_google_wallet: number;
  failed_google_wallet: number;
  google_wallet_success_rate: number;
  total_apple_wallet: number;
